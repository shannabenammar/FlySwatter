...
public class BounceObject : MonoBehaviour
{
    ...
    public float MoveRange = .3f; //change this to increase/decrease the distance between the highest and lowest points of the bounce
    ...
    void Update()
    {
        if (Move) //bool is checked
            ...
            bounceObject.transform.position = startPosition + MoveVector;
        //startPosition + MoveVector * (MoveRange * Mathf.Sin(Time.timeSinceLevelLoad * MoveSpeed));
